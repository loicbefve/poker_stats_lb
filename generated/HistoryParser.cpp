...
void HistoryParser::FichierContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<HistoryListener *>(listener);
...
antlrcpp::Any HistoryParser::FichierContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<HistoryVisitor*>(visitor))
...
HistoryParser::FirstLineContext* HistoryParser::firstLine() {
  ...
  try {
    enterOuterAlt(_localctx, 1);
    setState(213);
    match(HistoryParser::T__0);
    setState(214);
    gameInfo();
    setState(215);
    match(HistoryParser::T__1);
    setState(216);
    handId();
    setState(217);
    match(HistoryParser::T__1);
...
HistoryParser::BuyinContext* HistoryParser::buyin() {
  ...
  try {
    enterOuterAlt(_localctx, 1);
    setState(237);
    match(HistoryParser::T__4);
    setState(238);
    buyValue();
    setState(239);
    match(HistoryParser::T__5);
    setState(240);
    rakeBuyValue();
    setState(241);
    match(HistoryParser::T__6);
...
HistoryParser::TypePlayContext* HistoryParser::typePlay() {
  ...
  try {
    enterOuterAlt(_localctx, 1);
    setState(257);
    match(HistoryParser::T__9);
    setState(258);
    match(HistoryParser::LPAREN);
    setState(259);
    anteValue();
    setState(260);
    match(HistoryParser::T__10);
    setState(261);
    smallblindValue();
    setState(262);
    match(HistoryParser::T__10);
...
HistoryParser::WhoIsButtonContext* HistoryParser::whoIsButton() {
  ...
  try {
    enterOuterAlt(_localctx, 1);
    setState(323);
    match(HistoryParser::T__16);
    setState(324);
    buttonId();
    setState(325);
    match(HistoryParser::T__17);
...
HistoryParser::AnteligneContext* HistoryParser::anteligne() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if (_la == HistoryParser::T__20) {
      setState(365);
      match(HistoryParser::T__20);
    }
...
HistoryParser::RaiseActionContext* HistoryParser::raiseAction() {
  ...
  try {
    ...
    pseudo();
    setState(419);
    match(HistoryParser::T__25);
    setState(420);
    initialRaiseValue();
    setState(421);
    match(HistoryParser::T__26);
    setState(422);
    finalraiseValue();
    setState(424);
    _errHandler->sync(this);
...
HistoryParser::WinContext* HistoryParser::win() {
  ...
  try {
    ...
    pseudo();
    setState(453);
    match(HistoryParser::T__31);
    setState(454);
    match(HistoryParser::NUMBER);
    setState(455);
    match(HistoryParser::T__32);
...
HistoryParser::WhereCollectedContext* HistoryParser::whereCollected() {
  ...
  try {
    ...
    switch (_input->LA(1)) {
      ...
      case HistoryParser::T__38: {
        enterOuterAlt(_localctx, 2);
        setState(573);
        match(HistoryParser::T__38);
        setState(574);
        _la = _input->LA(1);
        if (!(_la == HistoryParser::DIGIT
      ...
      case HistoryParser::T__39: {
        enterOuterAlt(_localctx, 3);
        setState(575);
        match(HistoryParser::T__39);
        break;
      }
...
HistoryParser::PotSummaryContext* HistoryParser::potSummary() {
  ...
  try {
    enterOuterAlt(_localctx, 1);
    setState(592);
    match(HistoryParser::T__41);
    setState(593);
    potValue();
    setState(594);
    match(HistoryParser::T__42);
    setState(597);
    _errHandler->sync(this);
    switch (_input->LA(1)) {
      case HistoryParser::T__43: {
        setState(595);
        match(HistoryParser::T__43);
        break;
      }
...
HistoryParser::PlayerSummaryContext* HistoryParser::playerSummary() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if (_la == HistoryParser::T__45) {
      setState(619);
      match(HistoryParser::T__45);
      setState(620);
      cartePerso();
    }
    setState(623);
